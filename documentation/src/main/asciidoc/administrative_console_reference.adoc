...
`snowowl listrepositories [-v]` prints all the repositories in the system.  By adding '-v' to the command, a more verbose output is printed with additional meta information about the repositories.
....
