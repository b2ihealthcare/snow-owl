...
lower. The files are intended for use by support and admin personnel to report and diagnose runtime problems.
...
number files rolling over. Documentation on the logging configuration settings can be found here: http://logback.qos.ch.
