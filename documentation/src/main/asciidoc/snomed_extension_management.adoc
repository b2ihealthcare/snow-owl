...
....
>sctimport rf2_release -t full -v 
/path/to/file/SnomedCT_RF2Release_INT_20160131.zip /path/to/file/snomed_ct_international.json
....
...
....
>sctimport rf2_release -t full -b 2016-01-31
/path/to/file/SnomedCT_Release_INT_20160526-1116_b2i_cd_refsets.zip /path/to/file/snomed_ct_b2i_extension.json
....
...
After the import process, check the terminology registry for entry representing the International release:
....
