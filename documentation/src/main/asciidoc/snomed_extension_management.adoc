...
{
  "source": "MAIN/2016-01-31/Extension_bracnh",
...
POST /snowowl/snomed-ct/v2/merges
{
  "source": "MAIN/2016-07-31/Extension_bracnh",
...
POST /snowowl/admin/codesystems
{
	...
	"terminologyId": "com.b2international.snowowl.terminology.snomed",
	"repositoryUuid": "snomedStore",
	"branchPath": "MAIN/2015-01-31/SNOMEDCT-SV",
	"extensionOf": "SNOMEDCT"
}
....
...
POST /snowowl/snomed-ct/v2/imports
{
  ...
  "type": "FULL",
  "branchPath": "MAIN/2015-01-31/SNOMEDCT-SV",
  "codeSystemShortName": "SNOMEDCT-SV"
}
....
...
POST /snowowl/snomed-ct/v2/merges
{
  "source": "MAIN/2015-01-31/SNOMEDCT-SV",
  "target": "MAIN/2016-01-31/SNOMEDCT-SV",
...
....
PUT /snowowl/admin/codesystems/SNOMEDCT-SV
{
  "repositoryUuid": "snomedStore",
  "branchPath": "MAIN/2016-01-31/SNOMEDCT-SV"
}
....
