 ...
 * @since 6.4
 */
public interface OsHitConverter<T> {

	T convert(SearchHit hit) throws IOException;
	
	final class FieldValueHitConverter<T> implements OsHitConverter<T> {
	...
	final class SourceAsMapHitConverter<T> implements OsHitConverter<T> {
	...
	final class FieldsAsMapHitConverter<T> implements OsHitConverter<T> {
	...
	final class SourceAsStringArrayHitConverter<T> implements OsHitConverter<T> {
	...
	final class FieldsAsStringArrayHitConverter<T> implements OsHitConverter<T> {
	...
	final class SourceAsObjectHitConverter<T> implements OsHitConverter<T> {
	...
	final class FieldsAsObjectHitConverter<T> implements OsHitConverter<T> {
	...
	final class SourceAsJsonNodeHitConverter<T> implements OsHitConverter<T> {
	...
	static <T> OsHitConverter<T> getConverter(ObjectMapper mapper, Class<T> select, Class<?> from, boolean fetchSource, List<String> fields) {
