 ...
 * <p>
 * The type of the variable annotated with {@ExtendScript} must extend {@link groovy.lang.Script}.
 ...
 * }
 * {@code @ExtendScript} CustomScript extendedScript
 * assert extendedScript == this
 * assert theMeaningOfLife == 42
 * assert theMeaningOfLife == extendedScript.theMeaningOfLife
 * </pre>
 ...
 * method. <code>extendedScript</code> variable will become typed shortcut for 
...
@GroovyASTTransformationClass("com.b2international.commons.groovy.transform.ExtendScriptASTTransformation")
public @interface ExtendScript {
}
