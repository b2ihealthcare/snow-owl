...
/**
 * Handles transformation for the @ExtendScript annotation.
 *
 * @author Paul King
...
public class ExtendScriptASTTransformation extends AbstractASTTransformation {

    private static final Class<ExtendScript> MY_CLASS = ExtendScript.class;
