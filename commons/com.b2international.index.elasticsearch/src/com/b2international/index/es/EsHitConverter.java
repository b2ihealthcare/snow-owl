 ...
 * @since 6.4
 */
public interface EsHitConverter<T> {

	T convert(SearchHit hit) throws IOException;
	
	final class FieldValueHitConverter<T> implements EsHitConverter<T> {
	...
	final class SourceAsMapHitConverter<T> implements EsHitConverter<T> {
	...
	final class FieldsAsMapHitConverter<T> implements EsHitConverter<T> {
	...
	final class SourceAsStringArrayHitConverter<T> implements EsHitConverter<T> {
	...
	final class FieldsAsStringArrayHitConverter<T> implements EsHitConverter<T> {
	...
	final class SourceAsObjectHitConverter<T> implements EsHitConverter<T> {
	...
	final class FieldsAsObjectHitConverter<T> implements EsHitConverter<T> {
	...
	final class SourceAsJsonNodeHitConverter<T> implements EsHitConverter<T> {
	...
	static <T> EsHitConverter<T> getConverter(ObjectMapper mapper, Class<T> select, Class<?> from, boolean fetchSource, List<String> fields) {
