...
import com.b2international.index.es.EsScriptFactory;
...
public final class EsQueryBuilder {
	...
	private void visit(ScriptQueryExpression expression) {
		deque.push(QueryBuilders.scriptQuery(EsScriptFactory.INSTANCE.toEsScript(expression, mapping)));
	}
	...
	private void visit(ScriptScoreExpression expression) {
		...
		deque.push(QueryBuilders
				.functionScoreQuery(innerQuery, ScoreFunctionBuilders.scriptFunction(EsScriptFactory.INSTANCE.toEsScript(expression, mapping)))
