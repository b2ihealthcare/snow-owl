 ...
 * @since 7.2
 */
public final class ClusterStatus implements Serializable {

	private final boolean available;
	private final String diagnosis;
	private final List<IndexStatus> indices;
	
	public ClusterStatus(final boolean available, final String diagnosis, final List<IndexStatus> indices) {
	...
	public List<IndexStatus> getIndices() {
		return indices;
	}
	...
	public boolean isHealthy(String...indices) {
		final Stream<IndexStatus> stream;
		if (indices != null) {
		...
		return stream.allMatch(IndexStatus::isHealthy);
	}
