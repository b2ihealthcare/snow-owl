...
public class LookupResultSerializationTest extends FhirTest {
	...
	public void missingNameTest() throws Exception {
		...
		Issue expectedIssue = builder.addLocation("LookupResult.name")
				.detailsWithDisplay(OperationOutcomeCode.MSG_PARAM_INVALID, "Parameter 'name' content is invalid [null]. Violation: must not be empty.")
				.build();
	...
	public void emptyNameTest() throws Exception {
		...
		Issue expectedIssue = builder.addLocation("LookupResult.name")
			.detailsWithDisplay(OperationOutcomeCode.MSG_PARAM_INVALID, "Parameter 'name' content is invalid []. Violation: must not be empty.")
			.build();
	...
	public void missingDisplayTest() throws Exception {
		...
		Issue expectedIssue = builder.addLocation("LookupResult.display")
			.detailsWithDisplay(OperationOutcomeCode.MSG_PARAM_INVALID, "Parameter 'display' content is invalid [null]. Violation: must not be empty.")
			.build();
