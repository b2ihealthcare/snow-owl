...
public class DesignationSerializationTest extends FhirTest {
	...
	public void missingValueTest() throws Exception {
		...
		Issue expectedIssue = builder.addLocation("Designation.value")
				.detailsWithDisplay(OperationOutcomeCode.MSG_PARAM_INVALID, "Parameter 'value' content is invalid [null]. Violation: must not be empty.")
				.build();
	...
	public void emptyValueTest() throws Exception {
		...
		Issue expectedIssue = builder.addLocation("Designation.value")
				.detailsWithDisplay(OperationOutcomeCode.MSG_PARAM_INVALID, "Parameter 'value' content is invalid []. Violation: must not be empty.")
				.build();
