 ...
 * @since 8.0
 */
public class FhirCodeSystemSearchParameters {
	...
	void set_elements(String[] _elements) {
		this._elements = _elements;
	}
	
	void set_lastUpdated(String _lastUpdated) {
