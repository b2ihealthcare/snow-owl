...
/**
 * REST resource input that carries a FHIR value set and a map translating from FHIR system URIs to Snow Owl's resource URIs.
 * <p>
 * Example: <code>http://loinc.org</code> &rarr; <code>codesystems/LOINC/2.73</code>
 * 
 * @since 8.5.3
 */
public class ValueSetWithUriMapping {
