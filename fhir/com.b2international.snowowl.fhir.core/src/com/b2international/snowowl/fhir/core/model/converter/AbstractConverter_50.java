...
import org.linuxforhealth.fhir.model.r5.type.code.ContactPointSystem;
import org.linuxforhealth.fhir.model.r5.type.code.ContactPointUse;
import org.linuxforhealth.fhir.model.r5.type.code.IdentifierUse;
import org.linuxforhealth.fhir.model.r5.type.code.NarrativeStatus;
...
public abstract class AbstractConverter_50 {
	...
	protected Code fromInternalToCode(java.lang.String value) {
		if (StringUtils.isEmpty(value)) {
			return null;
		}
