 ...
 * @since 8.2.0
 */
public final class FhirCodeSystemUpdateRequestBuilder implements ResourceRepositoryRequestBuilder<FhirCodeSystemWriteSupport.UpdateResult> {
	...
	@Override
	public Request<RepositoryContext, FhirCodeSystemWriteSupport.UpdateResult> build() {
