...
import org.linuxforhealth.fhir.model.r4b.resource.Bundle.Link;
 ...
 * @since 9.0
 */
public class BundleConverter_43 extends AbstractConverter_43 implements BundleConverter<Bundle> {

	public static final BundleConverter<Bundle> INSTANCE = new BundleConverter_43();
	
	private BundleConverter_43() {
		super();
	}
	...
	private Bundle.Link fromInternal(com.b2international.snowowl.fhir.core.model.Link link) {
		...
		builder.relation(fromInternal(link.getRelation()));
