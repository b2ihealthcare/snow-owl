 ...
 * property). The canonical type differs from a {@link UriType uri} in that it has special
 * meaning in this specification, and in that it may have a version appended,
 * separated by a vertical bar (|).
 * 
 * @see <a href="https://hl7.org/fhir/R5/datatypes.html#canonical">2.1.28.0.1 Primitive Types - canonical</a>
 * @since 9.0
 */
public class CanonicalType extends UriType {

	public CanonicalType(String value) {
		super(value);
	}
}
