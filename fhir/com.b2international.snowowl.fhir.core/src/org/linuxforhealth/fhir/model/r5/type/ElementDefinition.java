...
import org.linuxforhealth.fhir.model.r5.type.code.AggregationMode;
import org.linuxforhealth.fhir.model.r5.type.code.BindingStrength;
import org.linuxforhealth.fhir.model.r5.type.code.ConstraintSeverity;
import org.linuxforhealth.fhir.model.r5.type.code.DiscriminatorType;
import org.linuxforhealth.fhir.model.r5.type.code.PropertyRepresentation;
import org.linuxforhealth.fhir.model.r5.type.code.ReferenceVersionRules;
import org.linuxforhealth.fhir.model.r5.type.code.SlicingRules;
 ...
 * Changes:
 * 
 * - Disallowed certain datatypes appearing in an ElementDefinition
 *   + Address
 *   + Age
 *   + Annotation
 *   + Availability
...
public class ElementDefinition extends BackboneType {
    ...
    @Summary
    @org.linuxforhealth.fhir.model.r5.annotation.Binding(
...
When an element within a pattern[x] is used to 
     * constrain an array, it means that each element provided in the pattern[x] must (recursively) match at least one 
     * element from the instance array.

When pattern[x] is used to constrain a complex object, it means that each property 
     * in the pattern must be present in the complex object, and its value must recursively match -- i.e.,

1. If primitive: 
     * it must match exactly the pattern value
2. If a complex object: it must match (recursively) the pattern value
3. If an 
     * array: it must match (recursively) the pattern value

If a pattern[x] is declared on a repeating element, the pattern 
     * applies to all repetitions. If the desire is for a pattern to apply to only one element or a subset of elements, 
     * slicing must be used. See [Examples of Patterns](elementdefinition-examples.html#pattern-examples) for examples of 
...
If a pattern[x] is declared on a repeating element, the pattern 
        ...
        protected void validate(ElementDefinition elementDefinition) {
            ...
            ValidationSupport.choiceElement(elementDefinition.defaultValue, "defaultValue",
				Base64Binary.class,
				Boolean.class,
				Canonical.class,
				Code.class,
            ...
            ValidationSupport.choiceElement(elementDefinition.fixed, "fixed",
				Base64Binary.class,
				Boolean.class,
				Canonical.class,
				Code.class,
            ...
            ValidationSupport.choiceElement(elementDefinition.pattern, "pattern",
				Base64Binary.class,
				Boolean.class,
				Canonical.class,
				Code.class,
    ...
    public static class Example extends BackboneElement {
        ...
        public static class Builder extends BackboneElement.Builder {
            ...
            protected void validate(Example example) {
                ...
                ValidationSupport.requireChoiceElement(example.value, "value",
					Base64Binary.class,
					Boolean.class,
					Canonical.class,
					Code.class,
    ...
    public static class Binding extends BackboneElement {
        ...
        @Summary
        private final List<Element> additional;
         ...
         */
        public List<Element> getAdditional() {
            return additional;
        }
        ...
        public void accept(java.lang.String elementName, int elementIndex, Visitor visitor) {
            if (visitor.preVisit(this)) {
                ...
                if (visitor.visit(elementName, elementIndex, this)) {
                    ...
                    accept(additional, "additional", visitor, Element.class);
                }
                visitor.visitEnd(elementName, elementIndex, this);
                visitor.postVisit(this);
            }
        ...
        public static class Builder extends BackboneElement.Builder {
             ...
             *     A reference to this Builder instance
             */
            public Builder additional(Element... additional) {
                for (Element value : additional) {
             ...
             *     If the passed collection is null
             */
            public Builder additional(Collection<Element> additional) {
            ...
            protected void validate(Binding binding) {
                ...
                ValidationSupport.checkList(binding.additional, "additional", Element.class);
