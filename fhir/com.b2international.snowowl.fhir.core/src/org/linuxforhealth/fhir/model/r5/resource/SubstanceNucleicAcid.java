...
Modifier extensions 
    ...
    public static class Subunit extends BackboneElement {
         ...
         * represented from the 5' to the 3' end, the 5’ prime nucleotide is the letter at the first position in the sequence. 
...
Modifier extensions 
        ...
        public static class Linkage extends BackboneElement {
             ...
             * Linkage connectivity is assumed to be 3’-5’. If the linkage is either 3’-3’ or 5’-5’ this should be 
             * specified.
             * 
             * @return
             *     An immutable object of type {@link String} that may be null.
