...
Future 
     * versions of FHIR may make significant changes to Trial Use content that are not compatible with previously published 
     * content.
     */
     ...
     * Withdrawn
     * 
     * <p>This content has been removed from the specification.
     */
    public static final StandardsStatus WITHDRAWN = StandardsStatus.builder().value(Value.WITHDRAWN).build();
