...
import org.linuxforhealth.fhir.model.r5.type.code.SortDirection;
import org.linuxforhealth.fhir.model.r5.type.code.ValueFilterComparator;
...
public class DataRequirement extends DataType {
    ...
    @Summary
    private final List<Element> valueFilter;
    @Summary
...
The value of mustSupport SHALL be a FHIRPath resolvable on the type of the DataRequirement. The path 
     ...
     */
    public List<Element> getValueFilter() {
        return valueFilter;
    }
    ...
    public void accept(java.lang.String elementName, int elementIndex, Visitor visitor) {
        if (visitor.preVisit(this)) {
            ...
            if (visitor.visit(elementName, elementIndex, this)) {
                ...
                accept(valueFilter, "valueFilter", visitor, Element.class);
    ...
    public static class Builder extends DataType.Builder {
        ...
        private List<Element> valueFilter = new ArrayList<>();
...
The value of mustSupport SHALL be a FHIRPath resolvable on the type of the DataRequirement. The path 
         ...
         *     A reference to this Builder instance
         */
        public Builder valueFilter(Element... valueFilter) {
            for (Element value : valueFilter) {
         ...
         *     If the passed collection is null
         */
        public Builder valueFilter(Collection<Element> valueFilter) {
        ...
        protected void validate(DataRequirement dataRequirement) {
            ...
            ValidationSupport.checkList(dataRequirement.valueFilter, "valueFilter", Element.class);
