...
The type is the Canonical URL of Resource Definition 
     * that is the type this reference refers to. References are URLs that are relative to http://hl7.
     * org/fhir/StructureDefinition/ e.g. "Patient" is a reference to http://hl7.org/fhir/StructureDefinition/Patient. 
     * Absolute URLs are only allowed for logical models (and can only be used in references in logical models, not 
     * resources).
     * 
     * @return
    ...
    public static class Builder extends Element.Builder {
         ...
         *     A reference to this Builder instance
         * 
         * @see #reference(org.linuxforhealth.fhir.model.r4b.type.String)
         */
