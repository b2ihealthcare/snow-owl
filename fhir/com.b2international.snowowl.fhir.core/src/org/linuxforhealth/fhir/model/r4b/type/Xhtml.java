 ...
 * Changes:
 * 
 * - Replaced use of org.owasp.encoder.Encode with org.apache.commons.lang3.StringEscapeUtils  
 */
...
public class Xhtml extends Element {
    ...
    public static Xhtml from(java.lang.String plainText) {
        ...
        // XXX: Replacing OWASP with an Apache Commons Lang3 utility method
        return Xhtml.builder().value(DIV_OPEN + StringEscapeUtils.escapeXml11(plainText) + DIV_CLOSE).build();
    }
