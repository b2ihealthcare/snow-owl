...
public abstract class EclEvaluationRequest<C extends ServiceProvider> implements Request<C, Promise<Expression>> {
	...
	protected Expression toExpression(final TypedSearchTermClause clause) {
		...
		switch (lexicalSearchType) {
			case MATCH:
				return termMatchExpression(com.b2international.snowowl.core.request.search.TermFilter.defaultTermMatch(term));
			case WILD:
	...
	protected Expression termMatchExpression(com.b2international.snowowl.core.request.search.TermFilter termFilter) {
