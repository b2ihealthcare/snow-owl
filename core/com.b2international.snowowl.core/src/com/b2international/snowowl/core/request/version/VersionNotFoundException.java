...
/**
 * Thrown when a version can not be found for a given version identifier.
 */
public class VersionNotFoundException extends NotFoundException {
	 ...
	 * 
	 * @param versionId the identifier of the version which could not be found (may not be {@code null})
	 */
	public VersionNotFoundException(final String versionId) {
