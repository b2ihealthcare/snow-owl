...
/**
 * Common interface for index searchers on the client side that track their currently active {@link IBranchPath}.
 * 
 ...
 * 
 */
public interface IClientIndexService<E extends IIndexEntry> {
	 ...
	 */
	public <E2 extends E> List<E2> search(final IIndexQueryAdapter<E2> queryAdapter);
	 ...
	 */
	public <E2 extends E> List<E2> search(final IIndexQueryAdapter<E2> queryAdapter, final int limit);
	 ...
	 */
	public <E2 extends E> int getHitCount(final IIndexQueryAdapter<E2> queryAdapter);
}