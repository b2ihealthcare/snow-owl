...
public final class TerminologyResourceCollections extends PageableCollectionResource<TerminologyResourceCollection> {
	...
	public TerminologyResourceCollections(int limit, int total) {
		this(List.of(), null, limit, total);
	}
	
	@JsonCreator
	public TerminologyResourceCollections(
			@JsonProperty("items") List<TerminologyResourceCollection> items, 
