 ...
 * 
 * @param <C> the input model type (used when creating a new component; must implement {@link RepositoryAction})
 ...
 */
public interface IComponentService<C extends RepositoryAction, R extends IComponent, U> {
