...
/**
 * Fixed OpenApiOperationTagsReader implementation, controllerTags method should look for Tags/Tag on the controller and not on the method
 */
@Component
@Order(SwaggerPluginSupport.OAS_PLUGIN_ORDER)
public class FixedOpenApiOperationTagsReader implements OperationBuilderPlugin {
