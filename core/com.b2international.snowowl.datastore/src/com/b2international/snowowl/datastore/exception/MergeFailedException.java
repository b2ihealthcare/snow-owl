...
/**
 * Checked exception indicating that merge failed.
 *  
...
public class MergeFailedException extends Exception {
	...
	public MergeFailedException(String arg0, Throwable arg1) {
		super(arg0, arg1);
	}

	public MergeFailedException(String arg0) {
		super(arg0);
	}

	public MergeFailedException(Throwable arg0) {
		super(arg0);
	}
}