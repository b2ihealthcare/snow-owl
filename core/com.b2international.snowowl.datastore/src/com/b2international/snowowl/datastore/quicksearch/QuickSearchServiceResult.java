...
public class QuickSearchServiceResult implements Serializable {
	...
	public QuickSearchContentResult getComponents(final String providerId) {
		Preconditions.checkNotNull(providerId, "Provider ID argument cannot be null.");
		return results.get(providerId);
	}
}