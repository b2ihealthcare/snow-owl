...
/**
 * A service configuration job which creates a quick search client RPC proxy when connecting to a remote server. 
 *
 */
public class QuickSearchClientServiceConfigJob extends AbstractClientServiceConfigJob<IQuickSearchService> {

	private static final String JOB_NAME = "Quick search client service configuration...";
	
	public QuickSearchClientServiceConfigJob() {
