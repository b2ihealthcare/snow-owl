 ...
 *
 */
public interface NodeDiff extends Serializable, Change, IconIdProvider<String>, LabelProvider, 
	TerminologyComponentIdProvider, HierarchicalElement<NodeDiff>, IdProvider<String> {
