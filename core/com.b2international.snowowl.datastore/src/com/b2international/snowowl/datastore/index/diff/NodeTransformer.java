...
/**
 * Transformer to convert a bunch of {@link NodeDiff node diffs} into a {@link NodeChange}.
 *
 */
public interface NodeTransformer {
	...
	/**Null implementation. Always supplies a {@link NodeChange#NULL_IMPL}.*/
	NodeTransformer NULL_IMPL = new NodeTransformer() {
		public NodeChange transform(final VersionCompareConfiguration configuration, final NodeDiff diff) {
			return NodeChange.NULL_IMPL;
		}
	};
