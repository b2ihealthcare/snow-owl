...
/**
 * Class for registering the {@link ITagService} to the client-side. 
 *
 */
public class TagServiceClientConfigJob extends AbstractClientServiceConfigJob<ITagService> {

	private static final String JOB_NAME = "Tag client service configuration...";
	
	/**Sole constructor.*/
	public TagServiceClientConfigJob() {
	 ...
	 */
	@Override
	protected Class<ITagService> getServiceClass() {
		return ITagService.class;
	}
