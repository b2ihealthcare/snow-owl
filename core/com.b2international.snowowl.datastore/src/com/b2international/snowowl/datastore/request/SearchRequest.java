 ...
 * @since 5.2
 */
public abstract class SearchRequest<B> extends BaseResourceRequest<RepositoryContext, B> {
	...
	void setDocIds(Collection<String> docIds) {
		this.docIds = docIds;
	}
	...
	protected Expression createComponentIdFilter() {
		return Expressions.matchAny(getIdField(), docIds);
	}
	...
	protected abstract B doExecute(RepositoryContext context) throws IOException;
