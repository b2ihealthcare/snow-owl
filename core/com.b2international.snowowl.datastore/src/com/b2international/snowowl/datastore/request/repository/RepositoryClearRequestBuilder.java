 ...
 * @since 5.12
 */
public final class RepositoryClearRequestBuilder extends BaseRequestBuilder<RepositoryClearRequestBuilder, TransactionContext, Boolean> implements TransactionalRequestBuilder<Boolean>{
	
	RepositoryClearRequestBuilder() {}
