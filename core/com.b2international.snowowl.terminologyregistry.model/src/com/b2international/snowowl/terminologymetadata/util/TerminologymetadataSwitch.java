 ...
 */
package com.b2international.snowowl.terminologymetadata.util;
 ...
 * @generated
 */
public class TerminologymetadataSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static TerminologymetadataPackage modelPackage;
	 ...
	 * @generated
	 */
	public TerminologymetadataSwitch() {
		if (modelPackage == null) {
			modelPackage = TerminologymetadataPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TerminologymetadataPackage.CODE_SYSTEM: {
