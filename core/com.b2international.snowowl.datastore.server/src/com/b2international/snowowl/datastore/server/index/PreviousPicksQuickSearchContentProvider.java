...
public class PreviousPicksQuickSearchContentProvider implements IQuickSearchContentProvider {
	...
	public QuickSearchContentResult getComponents(@Nullable String queryExpression, @Nonnull IBranchPathMap branchPathMap, @Nonnegative int limit, @Nullable Map<String, Object> configuration) {
		return ApplicationContext.getInstance().getService(IPreviousPicksManager.class).getComponents(queryExpression, branchPathMap, limit, configuration);
	}
}