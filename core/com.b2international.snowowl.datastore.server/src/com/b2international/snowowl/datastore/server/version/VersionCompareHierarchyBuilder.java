...
/**
 * Representation of a helper service responsible for building a hierarchy among changed components 
 * after a successful version compare process.
 *
 */
public interface VersionCompareHierarchyBuilder {

	/**
	 * Creates a placeholder unchanged item representing a component with its unique component ID on 
	 * the given branch.
	 ...
	 * @param branchPath the branch path where the component last existed.
	...
	/**
	 * Returns {@code true} if the node argument representing a terminology component is a root 
	 * node in the associated terminology. Otherwise {@code false}.
	 ...
	 * @param configuration configuration used for the version compare.
	 ...
	 * @param nodeDiffs an iterable of node differences representing a hierarchy to collapse.
	 */
