...
/**
 * Job for registering the {@link VersionCompareExporterService} onto the server-side.
 *
 */
public class VersionCompareExporterServiceConfigJob extends ServiceConfigJob {

	private static final String JOB_NAME = "Version compare exporter service configuration...";

	public VersionCompareExporterServiceConfigJob() {
