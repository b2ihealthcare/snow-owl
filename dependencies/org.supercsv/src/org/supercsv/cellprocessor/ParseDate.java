...
/**
 * Convert a string to a date using the {@link SimpleDateFormat} class. If you want to convert from a Date to a String, use the {@link FmtDate}
 * processor.
 * <p>
...
public class ParseDate extends CellProcessorAdaptor implements StringCellProcessor {
	...
	public ParseDate(final String format, Locale locale) {
		super();
	...
	public ParseDate(final String format, Locale locale, DateCellProcessor next) {
		super(next);
		this.formatter = new SimpleDateFormat(format, locale);
		formatter.setLenient(false);
	}

	public ParseDate setTimeZone(final TimeZone zone) {
	...
	public Object execute(final Object value, final CSVContext context) throws SuperCSVException {
		if (value == null) {
			throw new NullInputException("Input cannot be null on line " + context.lineNumber + " at column " + context.columnNumber, context, this);
		}
		try {
