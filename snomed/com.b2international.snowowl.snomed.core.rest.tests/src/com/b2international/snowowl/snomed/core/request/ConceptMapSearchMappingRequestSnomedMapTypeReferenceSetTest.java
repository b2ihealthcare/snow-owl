...
public class ConceptMapSearchMappingRequestSnomedMapTypeReferenceSetTest {
	...
	private String createSimpleMapTypeRefSet() {
		return SnomedRequests.prepareNewConcept()
				...
				.addRelationship(createIsaRelationship(Concepts.STATED_RELATIONSHIP, SnomedRefSetUtil.getParentConceptId(SnomedRefSetType.SIMPLE_MAP_FROM_SNOMEDCT)))
				.addRelationship(createIsaRelationship(Concepts.INFERRED_RELATIONSHIP, SnomedRefSetUtil.getParentConceptId(SnomedRefSetType.SIMPLE_MAP_FROM_SNOMEDCT)))
				.setRefSet(SnomedRequests.prepareNewRefSet()
						.setReferencedComponentType(SnomedTerminologyComponentConstants.CONCEPT)
						.setType(SnomedRefSetType.SIMPLE_MAP_FROM_SNOMEDCT))
