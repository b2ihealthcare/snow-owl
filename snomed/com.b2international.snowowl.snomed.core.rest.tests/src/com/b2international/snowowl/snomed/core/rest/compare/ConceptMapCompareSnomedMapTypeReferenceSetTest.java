 ...
 * @since 7.8
 */
public class ConceptMapCompareSnomedMapTypeReferenceSetTest {
	...
	private ResourceURI baseReferenceSetURI;
	private ResourceURI compareReferenceSetURI;
...
//	}
//	
//	private ConceptMapCompareResult compare(ResourceURI baseURI, ResourceURI compareURI) {
//		return ConceptMapRequests.prepareConceptMapCompare(baseURI, compareURI)
//				.setLocales("en")
