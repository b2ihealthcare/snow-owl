 ...
 * </p>
 * <ul>
 *   <li>{@link com.b2international.snowowl.snomed.ql.ql.impl.DescriptiontypeImpl#getEcl <em>Ecl</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DescriptiontypeImpl extends MinimalEObjectImpl.Container implements Descriptiontype
{
  ...
  public NotificationChain basicSetEcl(Script newEcl, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, QlPackage.DESCRIPTIONTYPE__ECL, oldEcl, newEcl);
  ...
  public void setEcl(Script newEcl)
  {
    if (newEcl != ecl)
    {
      ...
      if (ecl != null)
        msgs = ((InternalEObject)ecl).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - QlPackage.DESCRIPTIONTYPE__ECL, null, msgs);
      if (newEcl != null)
        msgs = ((InternalEObject)newEcl).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - QlPackage.DESCRIPTIONTYPE__ECL, null, msgs);
      msgs = basicSetEcl(newEcl, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, QlPackage.DESCRIPTIONTYPE__ECL, newEcl, newEcl));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case QlPackage.DESCRIPTIONTYPE__ECL:
