...
import com.b2international.snowowl.rest.snomed.domain.CreateReviewRequest;
...
@RestController
@RequestMapping(value="#{snomedApiBaseUrl}/reviews", produces={AbstractRestService.JSON_MEDIA_TYPE})
