...
import com.b2international.snowowl.rest.snomed.domain.SnomedDescriptionRestInput;
import com.b2international.snowowl.rest.snomed.domain.SnomedDescriptionRestSearch;
import com.b2international.snowowl.rest.snomed.domain.SnomedDescriptionRestUpdate;
...
@RestController
@RequestMapping(value="#{snomedApiBaseUrl}/{path:**}/descriptions")
