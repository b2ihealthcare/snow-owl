...
public class SCGStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new com.b2international.snowowl.dsl.SCGRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.b2international.com/snowowl/SCG")) {
		EPackage.Registry.INSTANCE.put("http://www.b2international.com/snowowl/SCG", com.b2international.snowowl.dsl.scg.ScgPackage.eINSTANCE);
	}
