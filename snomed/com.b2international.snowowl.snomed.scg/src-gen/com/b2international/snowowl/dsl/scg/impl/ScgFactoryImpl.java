...
public class ScgFactoryImpl extends EFactoryImpl implements ScgFactory
{
  ...
  public static ScgFactory init()
  {
    try
    {
      ScgFactory theScgFactory = (ScgFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.b2international.com/snowowl/SCG"); 
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case ScgPackage.CONCEPT: return createConcept();
      case ScgPackage.GROUP: return createGroup();
