 ...
 * </p>
 * <ul>
 *   <li>{@link com.b2international.snowowl.snomed.scg.scg.impl.SubExpressionImpl#getFocusConcepts <em>Focus Concepts</em>}</li>
 *   <li>{@link com.b2international.snowowl.snomed.scg.scg.impl.SubExpressionImpl#getRefinement <em>Refinement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubExpressionImpl extends AttributeValueImpl implements SubExpression
{
   ...
   * @ordered
   */
  protected EList<ConceptReference> focusConcepts;
  ...
  {
    return ScgPackage.Literals.SUB_EXPRESSION;
  }
   ...
   */
  @Override
  public EList<ConceptReference> getFocusConcepts()
  {
    if (focusConcepts == null)
    {
      focusConcepts = new EObjectContainmentEList<ConceptReference>(ConceptReference.class, this, ScgPackage.SUB_EXPRESSION__FOCUS_CONCEPTS);
    }
  ...
  public NotificationChain basicSetRefinement(Refinement newRefinement, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ScgPackage.SUB_EXPRESSION__REFINEMENT, oldRefinement, newRefinement);
  ...
  public void setRefinement(Refinement newRefinement)
  {
    if (newRefinement != refinement)
    {
      ...
      if (refinement != null)
        msgs = ((InternalEObject)refinement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ScgPackage.SUB_EXPRESSION__REFINEMENT, null, msgs);
      if (newRefinement != null)
        msgs = ((InternalEObject)newRefinement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ScgPackage.SUB_EXPRESSION__REFINEMENT, null, msgs);
      msgs = basicSetRefinement(newRefinement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScgPackage.SUB_EXPRESSION__REFINEMENT, newRefinement, newRefinement));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ScgPackage.SUB_EXPRESSION__FOCUS_CONCEPTS:
        return ((InternalEList<?>)getFocusConcepts()).basicRemove(otherEnd, msgs);
      case ScgPackage.SUB_EXPRESSION__REFINEMENT:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case ScgPackage.SUB_EXPRESSION__FOCUS_CONCEPTS:
        ...
        getFocusConcepts().addAll((Collection<? extends ConceptReference>)newValue);
        return;
      case ScgPackage.SUB_EXPRESSION__REFINEMENT:
