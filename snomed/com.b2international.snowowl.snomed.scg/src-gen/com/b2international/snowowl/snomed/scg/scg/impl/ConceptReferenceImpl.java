 ...
 * </p>
 * <ul>
 *   <li>{@link com.b2international.snowowl.snomed.scg.scg.impl.ConceptReferenceImpl#getId <em>Id</em>}</li>
 *   <li>{@link com.b2international.snowowl.snomed.scg.scg.impl.ConceptReferenceImpl#getTerm <em>Term</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConceptReferenceImpl extends AttributeValueImpl implements ConceptReference
{
  ...
  {
    return ScgPackage.Literals.CONCEPT_REFERENCE;
  }
  ...
  public void setId(String newId)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScgPackage.CONCEPT_REFERENCE__ID, oldId, id));
  }
  ...
  public void setTerm(String newTerm)
  {
    ...
    term = newTerm;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScgPackage.CONCEPT_REFERENCE__TERM, oldTerm, term));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ScgPackage.CONCEPT_REFERENCE__ID:
        return getId();
      case ScgPackage.CONCEPT_REFERENCE__TERM:
        return getTerm();
    }
