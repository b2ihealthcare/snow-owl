...
public class InputFactory {
	...
	private <I extends SnomedComponentCreateRequest<R>, R extends ISnomedComponent> ComponentInputCreator<I, R, BaseSnomedComponentUpdateRequest, ISnomedBrowserComponentWithId> getInputDelegate(Class<I> inputType) {
