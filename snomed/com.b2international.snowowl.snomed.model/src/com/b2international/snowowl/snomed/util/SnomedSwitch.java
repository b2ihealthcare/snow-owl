 ...
 * @generated
 */
public class SnomedSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SnomedPackage.COMPONENT: {
				Component component = (Component)theEObject;
				T result = caseComponent(component);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SnomedPackage.INACTIVATABLE: {
				Inactivatable inactivatable = (Inactivatable)theEObject;
				T result = caseInactivatable(inactivatable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SnomedPackage.ANNOTATABLE: {
				Annotatable annotatable = (Annotatable)theEObject;
				T result = caseAnnotatable(annotatable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SnomedPackage.DESCRIPTION: {
				Description description = (Description)theEObject;
				T result = caseDescription(description);
				if (result == null) result = caseComponent(description);
				if (result == null) result = caseInactivatable(description);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SnomedPackage.CONCEPT: {
				Concept concept = (Concept)theEObject;
				T result = caseConcept(concept);
				if (result == null) result = caseComponent(concept);
				if (result == null) result = caseInactivatable(concept);
				if (result == null) result = caseAnnotatable(concept);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SnomedPackage.RELATIONSHIP: {
				Relationship relationship = (Relationship)theEObject;
				T result = caseRelationship(relationship);
				if (result == null) result = caseComponent(relationship);
				if (result == null) result = caseAnnotatable(relationship);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Inactivatable</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Inactivatable</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseInactivatable(Inactivatable object) {
		return null;
	}
