 ...
 *
 */
public class SnomedComponentValidationServiceConfigJob extends AbstractServerServiceConfigJob<ISnomedComponentValidationService> {

	public SnomedComponentValidationServiceConfigJob() {
		super("Validation service configuration...", DatastoreServerActivator.PLUGIN_ID);
	}
	 ...
	 */
	@Override
	protected SnomedComponentValidationService createServiceImplementation() throws SnowowlServiceException {
		return new SnomedComponentValidationService();
	}
}