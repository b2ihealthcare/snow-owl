...
import com.b2international.snowowl.snomed.datastore.SnomedDescriptionLabelProviderServiceImpl;

/**
 * Job for registering the {@link SnomedDescriptionLabelProviderService description label provider service} for SNOMED&nbsp;CT onto the server-side. 
 */
public class SnomedDescriptionLabelProviderServiceConfigJob extends AbstractServerServiceConfigJob<SnomedDescriptionLabelProviderService> {

	public SnomedDescriptionLabelProviderServiceConfigJob() {
		super("SNOMED CT description label provider service configuration...", SnomedDatastoreServerActivator.PLUGIN_ID);
	}
	...
	@Override
	protected SnomedDescriptionLabelProviderService createServiceImplementation() throws SnowowlServiceException {
		return new SnomedDescriptionLabelProviderServiceImpl(); 
	}
