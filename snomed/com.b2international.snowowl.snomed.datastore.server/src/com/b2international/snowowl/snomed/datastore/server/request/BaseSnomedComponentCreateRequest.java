 ...
 * @since 4.0
 */
public abstract class BaseSnomedComponentCreateRequest<R extends ISnomedComponent> extends BaseRequest<TransactionContext, R> implements SnomedComponentCreateRequest<R> {
