...
public class SnomedMRCMModuleScopeRefSetExporter extends SnomedRefSetExporter {
	...
	public SnomedMRCMModuleScopeRefSetExporter(final SnomedExportContext exportContext, final SnomedReferenceSet refset, final RevisionSearcher revisionSearcher) {
	...
	public String convertToString(final SnomedRefSetMemberIndexEntry doc) {
		...
		sb.append(HT);
		sb.append(doc.getMrcmRuleRefsetId());
		return sb.toString();
	}
