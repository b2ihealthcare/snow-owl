 ...
 * @since 6.1.0
 */
public class SnomedMRCMAttributeRangeRefSetExporter extends SnomedRefSetExporter {

	public SnomedMRCMAttributeRangeRefSetExporter(final SnomedExportContext exportContext, final SnomedReferenceSet refset, final RevisionSearcher revisionSearcher) {
	...
	public String convertToString(final SnomedRefSetMemberIndexEntry doc) {
		...
		sb.append(HT);
		sb.append(doc.getRangeConstraint());
		sb.append(HT);
		sb.append(doc.getAttributeRule());
		sb.append(HT);
...
//			.append(SnomedRfFileNameBuilder.getPrefix(SnomedRefSetType.MRCM_ATTRIBUTE_RANGE, false))
//			.append("Refset_")
//			.append("MRCMAttributeRange")
