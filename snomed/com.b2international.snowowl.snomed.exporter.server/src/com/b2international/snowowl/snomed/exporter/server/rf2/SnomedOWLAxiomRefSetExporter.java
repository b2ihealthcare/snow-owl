 ...
 *
 */
public class SnomedOWLAxiomRefSetExporter extends SnomedRefSetExporter {

	public SnomedOWLAxiomRefSetExporter(final SnomedExportContext exportContext, final SnomedReferenceSet refset, final RevisionSearcher revisionSearcher) {
	...
	public String convertToString(final SnomedRefSetMemberIndexEntry doc) {
		...
		sb.append(HT);
		sb.append(doc.getOwlExpression());
		return sb.toString();
	}
