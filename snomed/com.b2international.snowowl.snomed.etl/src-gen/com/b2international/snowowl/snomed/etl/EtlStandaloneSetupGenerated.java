...
public class EtlStandaloneSetupGenerated implements ISetup {
	...
	public void register(Injector injector) {
		if (!EPackage.Registry.INSTANCE.containsKey("http://www.b2international.com/snowowl/snomed/etl/Etl")) {
			EPackage.Registry.INSTANCE.put("http://www.b2international.com/snowowl/snomed/etl/Etl", EtlPackage.eINSTANCE);
		}
