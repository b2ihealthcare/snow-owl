...
/**
 * Generates file name matching patterns for language reference sets.
 * 
 * @since 1.3
 */
public class LanguageRefsetReleaseFile extends ReleaseFile {

	public LanguageRefsetReleaseFile(final String initialSegment) {
	...
	public Pattern createPattern(final boolean testRelease, final ContentSubType contentSubType, final ReleaseIdentifier currentReleaseIdentifier,
		...
		patternBuilder.append("der2_cRefset_.*");
