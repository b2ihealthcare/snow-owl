 ...
 * 
 */
public class SnomedPreferencesClientServiceConfigJob extends AbstractClientServiceConfigJob<IReasonerPreferencesService> {

	private static final String JOB_NAME = "Snomed reasoner preferences client service configuration...";
	
	public SnomedPreferencesClientServiceConfigJob() {
	 ...
	 */
	@Override
	protected Class<IReasonerPreferencesService> getServiceClass() {
		return IReasonerPreferencesService.class;
	}
}