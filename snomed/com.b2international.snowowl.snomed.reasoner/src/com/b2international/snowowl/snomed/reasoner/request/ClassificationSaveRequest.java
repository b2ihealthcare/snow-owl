 ...
 * @since 5.7
 */
final class ClassificationSaveRequest implements Request<ServiceProvider, ApiError> {
	...
	ClassificationSaveRequest(String classificationId, ReasonerTaxonomy taxonomy, ReasonerTaxonomyBuilder taxonomyBuilder, String userId) {
