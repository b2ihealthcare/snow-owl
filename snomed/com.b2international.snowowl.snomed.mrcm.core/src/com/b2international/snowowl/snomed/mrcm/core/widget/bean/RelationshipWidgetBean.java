...
public class RelationshipWidgetBean extends LeafWidgetBean {
	 ...
	 * 
	 * @param model the relationship's originating model (may not be {@code null})
	 * @param sctId the relationship's SNOMED CT identifier; a value of {@link UNINITIALIZED} indicates a new
	 * relationship
	 * @param released {@code true} if the represented component is released. Otherwise {@code false}.
	 * @param universalRestriction flag indicating the DL restriction for the relationship. {@code true} if universal restriction, otherwise {@code false}.
	 */
	public RelationshipWidgetBean(final ConceptWidgetBean cwb, final RelationshipWidgetModel model, final long sctId, final boolean released, final boolean universalRestriction) {
	...
	/**
	 * Returns {@code true} if the SNOMED&nbsp;CT relationship's Description Logic (DL) restriction 
	 * is the {@link Concepts#UNIVERSAL_RESTRICTION_MODIFIER all} concept. Otherwise returns with {@code false}. 
	...
	/**
	 * Sets the flag whether the DL restriction of the current relationship is either {@code some}
	 * or {@code all}. {@code true} if {@code all}, otherwise {@code false}.
	 * @param universalRestriction the universalRestriction to set
	 */
	...
	protected RelationshipWidgetBean replicate() {
		final RelationshipWidgetBean relationshipWidgetBean = new RelationshipWidgetBean(cwb, getModel(), UNINITIALIZED, false, isUniversalRestriction());
	...
	public String toString() {
		return String.format("RelationshipWidgetBean [sctId=%s, selectedType=%s, selectedValue=%s, model=%s]", 
				sctId, selectedType, selectedValue,	getModel());
	}
