 ...
 */
public class WidgetModelProviderConfigJob extends AbstractServerServiceConfigJob<IWidgetModelProvider> {

	public WidgetModelProviderConfigJob() {
		super("Widget model provider configuration...", MrcmCoreServerActivator.PLUGIN_ID);
	}
	 ...
	 */
	@Override
	protected WidgetModelProvider createServiceImplementation() throws SnowowlServiceException {
		return WidgetModelProvider.INSTANCE;
	}
}