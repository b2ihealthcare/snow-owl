...
final class SnomedInactivationReasonUpdateRequest<C extends Inactivatable & Component> implements Request<TransactionContext, Void> {
	...
	private void updateEffectiveTime(final TransactionContext context, final SnomedAttributeValueRefSetMember existingMember) {
		...
		SnomedComponentUpdateRequest.tryUpdateMemberEffectiveTime(
			...
			(cdoMember, snomedMember) -> 
				...
				cdoMember.getValueId().equals(snomedMember.getProperties().get(SnomedRf2Headers.FIELD_VALUE_ID))
		);
