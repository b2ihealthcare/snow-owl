 ...
 */
@Client
public class SnomedClientIndexService extends ActiveBranchClientIndexService<SnomedIndexEntry> {

	public SnomedClientIndexService(final SnomedIndexService wrappedService) {
