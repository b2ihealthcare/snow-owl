...
/**
 * Task context for authoring simple and complex map type reference sets in the
 * SNOMED&nbsp;CT ontology.
 *
 */
public class SnomedMappingRefSetAuthoringTaskContext extends SnomedTaskContext implements ILookupServiceProvider, ITerminologyComponentIdProvider {

	private static final long serialVersionUID = 3269683504712114621L;

	/**Unique task context ID.*/
	public static final String ID = "com.b2international.snowowl.snomed.datastore.SnomedMappingRefSetAuthoringTaskContext";
	...
	public String getLabel() {
		return "SNOMED CT mapping reference set authoring";
	}
