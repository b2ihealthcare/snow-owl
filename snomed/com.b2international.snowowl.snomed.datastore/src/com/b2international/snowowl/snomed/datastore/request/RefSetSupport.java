...
public abstract class RefSetSupport {
	...
	private static final Multimap<SnomedRefSetType, String> SUPPORTED_REFERENCED_COMPONENTS = ImmutableMultimap.<SnomedRefSetType, String> builder()
			...
			.put(SnomedRefSetType.SIMPLE_MAP_FROM_SNOMEDCT, SnomedTerminologyComponentConstants.CONCEPT)
			...
			.put(SnomedRefSetType.SIMPLE_MAP_FROM_SNOMEDCT, SnomedTerminologyComponentConstants.DESCRIPTION)
