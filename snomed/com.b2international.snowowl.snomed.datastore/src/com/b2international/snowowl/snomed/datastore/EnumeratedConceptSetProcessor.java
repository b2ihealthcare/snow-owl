...
public class EnumeratedConceptSetProcessor extends ConceptSetProcessor<EnumeratedConceptSetDefinition> {
	...
	public EnumeratedConceptSetProcessor(EnumeratedConceptSetDefinition conceptSetDefinition, IClientTerminologyBrowser<SnomedConceptIndexEntry, String> terminologyBrowser2) {
	...
	private final class IdToConceptMiniFunction implements Function<String, SnomedConceptIndexEntry> {
		@Override public SnomedConceptIndexEntry apply(String input) {
