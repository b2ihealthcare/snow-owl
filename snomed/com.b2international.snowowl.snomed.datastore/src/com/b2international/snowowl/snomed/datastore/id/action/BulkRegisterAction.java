 ...
 * @since 4.5
 */
public class BulkRegisterAction extends IdAction<Collection<String>> {

	private final Collection<String> componentIds;

	public BulkRegisterAction(final Collection<String> componentIds, final ISnomedIdentifierService identifierService) {
