...
/**
 * Job for initializing and registering {@link SnomedPredicateBrowser} service to the client side.
 * <p>
 * <b>Note:</b> this class belongs to the {@link SnomedDatastoreActivator#PLUGIN_ID SNOMED&nbsp;CT data store plug-in identifier} job
 * family.
 *
 */
public class SnomedPredicateBrowserServiceConfigJob extends ClientServiceConfigJob<SnomedPredicateBrowser, SnomedClientPredicateBrowser> {

	private static final String JOB_NAME = "SNOMED CT predicate browser configuration...";
	
	public SnomedPredicateBrowserServiceConfigJob() {
	 ...
	 */
	@Override
	protected Class<SnomedPredicateBrowser> getServiceClass() {
	 ...
	 */
	@Override
	protected Class<SnomedClientPredicateBrowser> getTrackingClass() {
		return SnomedClientPredicateBrowser.class;
	}
	 ...
	 */
	@Override
	protected SnomedClientPredicateBrowser createTrackingService(final SnomedPredicateBrowser branchAwareService) {
		return new SnomedClientPredicateBrowser(branchAwareService);
	}
}