 ...
 * 
 */
public class NewRefSetMemberNode implements IRefSetMemberNode {
	...
	public NewRefSetMemberNode(final long conceptId, final String label) {
	...
	public IRegularRefSetMemberNode asRegularNode() {
		throw new ClassCastException("Can't cast new reference set node to regular node.");
	}
	...
	public boolean equals(final Object obj) {
		...
		if (!(obj instanceof NewRefSetMemberNode)) {
			return false;
		}
		final NewRefSetMemberNode other = (NewRefSetMemberNode) obj;
