...
public interface SnomedIndexInitializerQueries2 {
	...
	String SQL_GET_CONCEPTS_AND_DESCRIPTIONS = "SELECT "
			...
			+ "ORDER BY concept.ID, description.TYPE, description.EFFECTIVETIME DESC, description.ACTIVE DESC";
	
	String SQL_CREATE_TYPE_EFFECTIVETIME_ACTIVE_INDEX_ON_DESCRIPTION_TABLE = "CREATE INDEX "  
			+ "SNOMED_DESCRIPTION_TYPE_EFFECTIVETIME_ACTIVE_IDX " 
			+ "ON SNOMED_DESCRIPTION (TYPE, EFFECTIVETIME DESC, ACTIVE DESC)";
	
	String SQL_CREATE_ID_INDEX_ON_CONCEPT_TABLE = "CREATE INDEX " 
			+ "SNOMED_CONCEPT_ID_IDX "
			+ "ON SNOMED_CONCEPT (ID)";
	
	String SQL_DROP_TYPE_EFFECTIVETIME_ACTIVE_INDEX_ON_DESCRIPTION_TABLE = "DROP INDEX "  
			+ "SNOMED_DESCRIPTION_TYPE_EFFECTIVETIME_ACTIVE_IDX " 
			+ "/*! ON SNOMED_DESCRIPTION */";
	
	String SQL_DROP_ID_INDEX_ON_CONCEPT_TABLE = "DROP INDEX " 
			+ "SNOMED_CONCEPT_ID_IDX "
			+ "/*! ON SNOMED_CONCEPT */";
	...
	String SQL_GET_RELATIONSHIPS = "SELECT "
			...
			+ "source.ID, " // 1
			+ "destination.ID, " // 2 
			+ "relationship.CHARACTERISTICTYPE, " // 3
