...
public class BulkRegistrationData extends RequestData {
	...
	@JsonProperty("sctids")
	private Collection<String> componentIds = Lists.newArrayList();
	private Collection<String> systemIds = Lists.newArrayList();

	public BulkRegistrationData(final int namespace, final String software, final Collection<String> componentIds) {
