 ...
 * @see IfExistsComplexMapAttribute
 */
public class UnspecifiedIfExistsComplexMapAttribute implements IComplexMapAttribute {
...
private final Map<Object, Object> cache = Maps.newHashMap();
	...
	public String toString() {
		final Object id = cache.get(UNSPECIFIED_ID);
		final Object term = cache.get(SNOMED_CT_LABEL);
		final String idLabel = null == id ? UNSPECIFIED_ID : String.valueOf(id); 
