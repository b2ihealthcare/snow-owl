 ...
 * @since 4.4
 */
public class MrcmImporterClientConfigJob extends AbstractClientServiceConfigJob<MrcmImporter> {

	public MrcmImporterClientConfigJob() {
		super("Configuring MRCM client importer service...", "mrcm");
	}
