...
public class ConceptDefinitionMerger {
	 ...
	 * See {@link AttributeClauseListMerger}</br></br>
	 * 
	 ...
	 */
	public ConceptDefinition mergeDefinitions(Map<ConceptRef, ConceptDefinition> conceptDefinitions) {
		ConceptDefinition mergedConceptDefinition = new ConceptDefinition();
		AttributeClauseListMerger attributeGroupMerger = new AttributeClauseListMerger(subsumptionTester);
		attributeGroupMerger.mergeAttributeClauseGroups(conceptDefinitions, mergedConceptDefinition);
