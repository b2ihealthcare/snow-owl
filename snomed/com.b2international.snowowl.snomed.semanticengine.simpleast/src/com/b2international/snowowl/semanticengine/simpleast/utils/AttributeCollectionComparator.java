 ...
 * 
 */
public class AttributeCollectionComparator extends CollectionComparator<AttributeClause> {

	@Override
	protected boolean itemsEqual(AttributeClause expected, AttributeClause actual) {
