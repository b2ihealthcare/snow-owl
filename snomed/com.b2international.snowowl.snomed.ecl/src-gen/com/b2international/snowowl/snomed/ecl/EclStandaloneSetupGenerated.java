...
public class EclStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new com.b2international.snowowl.snomed.ecl.EclRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.b2international.com/snowowl/snomed/Ecl")) {
		EPackage.Registry.INSTANCE.put("http://www.b2international.com/snowowl/snomed/Ecl", com.b2international.snowowl.snomed.ecl.ecl.EclPackage.eINSTANCE);
	}
