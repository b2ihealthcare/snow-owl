...
public class AndRefinementImpl extends RefinementImpl implements AndRefinement
{
   ...
   * @ordered
   */
  protected AttributeConstraint right;
   ...
   * @generated
   */
  public AttributeConstraint getRight()
  {
    return right;
  }
   ...
   * @generated
   */
  public NotificationChain basicSetRight(AttributeConstraint newRight, NotificationChain msgs)
  {
    AttributeConstraint oldRight = right;
    right = newRight;
    if (eNotificationRequired())
    {
   ...
   * @generated
   */
  public void setRight(AttributeConstraint newRight)
  {
    if (newRight != right)
    {
      NotificationChain msgs = null;
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case EclPackage.AND_REFINEMENT__LEFT:
        ...
        return;
      case EclPackage.AND_REFINEMENT__RIGHT:
        setRight((AttributeConstraint)newValue);
        return;
    }
  ...
  public void eUnset(int featureID)
  {
    switch (featureID)
    {
      case EclPackage.AND_REFINEMENT__LEFT:
        ...
        return;
      case EclPackage.AND_REFINEMENT__RIGHT:
        setRight((AttributeConstraint)null);
        return;
    }
