 ...
 */
package com.b2international.snowowl.semanticengine.subsumption.test;
...
public class SubsumptionTesterTest {
	...
	private void testExpressionSubsumption(Expression predicate, Expression candidate, boolean expectedResult) {
		...
		TestUtils.printPerformanceStats("Subsumption test", iterationTimesInNanoseconds);
	}
	...
	public void testUngroupedAttributes() {
		 ...
		 */
		Expression candidateExpression = (Expression) SCGStandaloneSetup.parse("243796009:363589002=" +
				"17724006" + 
				",405813007=88727008" +
				",408729009=410515003" +
				",408731000=410512000" +
		 ...
		 *		, 408732007|subject relationship context| = 410604004|subject of record|" 
		 */
		Expression predicateExpression = (Expression) SCGStandaloneSetup.parse("243796009:363589002=" + 
				"312813005" + 
				",405813007=244310007" +
				",408729009=410515003" +
				",408731000=410512000" +
	...
	public void testExpressionAttributeValue1() {
		 ...
		 *		, 408732007|subject relationship context| = 410604004|subject of record| "
		 */
		Expression predicateExpression = (Expression) SCGStandaloneSetup.parse("243796009:246090004=(" +
				 "402138008:" + 
						"116676008=90120004" +
						",363714003=250467003)" +
			 		",408729009=410515003" +
		 ...
		 *		408732007|subject relationship context| = 410604004|subject of record| "
		 */
		Expression candidateExpression = (Expression) SCGStandaloneSetup.parse("243796009:246090004=(" +
				 "14560005:116676008="+
					 "419386004),"+
					 "408729009=410515003,"+
					 "408731000=410512000,"+
	...
	public void testKnownAbsent() {
		long parseStart = System.nanoTime();
		/*
		 * "243796009|Situation with explicit context| : 246090004|Associated finding| = 63041002|Acladiosis|,
		 * 		408729009|finding context| = 410516002|Known absent|
		 * 		, 408731000|temporal context| = 410512000|current or specified|
		 * 		, 408732007|subject relationship context| =410604004|subject of record| "
		 */
		Expression predicateExpression = (Expression) SCGStandaloneSetup.parse("243796009:{246090004=63041002"+
					",363714003=386053000,"+
					 "408729009=410516002"+
					",408731000=410512000"+
					",408732007=410604004}");
		...
		/* 
		 * "243796009|Situation with explicit context| : 246090004|Associated finding| = 14560005|Dermal mycosis|,
		 * 		408729009|finding context| = 410594000|Definitely not present|
		 * 		, 408731000|temporal context| = 410512000|current or specified|
		 * 		, 408732007|subject relationship context| =125676002|Person| "
		 */
		Expression candidateExpression = (Expression) SCGStandaloneSetup.parse("243796009:{246090004=14560005"+
				",363714003=386053000,"+
				 "408729009=410516002"+
				",408731000=410512000"+
				",408732007=125676002}");
