...
public class AllNormalFormGeneratorTests {
	...
	@ClassRule
	public static final SnowOwlAppRule appRule = SnowOwlAppRule.snowOwl().config(PlatformUtil.toAbsolutePath(AllNormalFormGeneratorTests.class, "semanticengine.simpleast-tests.json"));
