...
public class AntPathWildcardMatcherTests {
	...
	public void createMatcher() {
		pathMatcher = new AntPathWildcardMatcher();
	}
	...
	public void match() {
		...
		assertTrue(pathMatcher.match("/**/b/c", "/p1/p2/p3/b/c"));
		assertTrue(pathMatcher.match("/{bla:**}/b/c", "/p1/p2/p3/b/c"));
	}
	...
	public void extractUriTemplateVariablesRegex() {
		...
		result = pathMatcher.extractUriTemplateVariables("/{bla:**}/b/c", "/p1/p2/p3/b/c");
